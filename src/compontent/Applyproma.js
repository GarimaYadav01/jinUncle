            ...
            <View style={styles.modalContainer}>
                <View style={styles.contentContainer}>
                    <TouchableOpacity style={styles.closeButton} onPress={onClose}>
                        ...
                        <Image source={require("../assets/Icon/x-mark.png")} style={{ width: 30, height: 30 }} />
                    </TouchableOpacity>
