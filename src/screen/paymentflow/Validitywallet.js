        ...
        <SafeAreaView>
            ...
            <ScrollView>
                <View style={styles.con}>
                    ...
                    <Text style={styles.text2}>No, the validity of the rewards or uc credits cannot be extended.please use the credits before their validity expire.
                    </Text>
                    <Text style={styles.text2}>To check the validity of your rewards
                    </Text>
