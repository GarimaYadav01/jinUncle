        ...
        <SafeAreaView>
            ...
            <ScrollView>
                <View style={styles.con}>
                    ...
                    <Text style={styles.text2}>You can check you wallet balance from your profile section- my wallet
                    </Text>
                    <Text style={[styles.text2, { marginTop: 10 }]}>To check you wallet history
                    </Text>
